...
# Doc2Vec PV-DBOW
def train():    
    model = Doc2Vec(dm=0, min_count=0, window=10, vector_size=DIM_SIZE, hs=0, epochs=20, sample=0.0, negative=5, workers=5)
    ...
    print("yyyyyyyyyyyyyyyyyyyy: ",exDict )
    ...
    print("Xxxxxxxxxxxxxxxxxxxxxxxxxxxxx1:   ",len(sentences))
...
def get_srcs():
    ...
    pos_size = 0
    neg_size = 0
    dat_files = glob.glob('E:/Python/Python/SIN/sentiment-analysis/datasets/*.dat')
